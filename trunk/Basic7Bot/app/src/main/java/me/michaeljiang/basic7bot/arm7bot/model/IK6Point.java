package me.michaeljiang.basic7bot.arm7bot.model;

import me.michaeljiang.basic7bot.arm7bot.Arm7Bot_Send;
...
public class IK6Point {
    ...
    private int[] vec56={0,300,0};  //现在Point6点的向量朝向
    private int[] vec67={0,0 ,100};  //现在Point6点的向量朝向
